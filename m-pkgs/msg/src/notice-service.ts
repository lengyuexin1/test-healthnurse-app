...
export const NoticeService = new Service()

/** 消息通知的会话对象 */
export const useNoticeSessions = () => {
    return NoticeService.data
}

/** 获取消息列表分页器 */
export const useNoticeList = (to: string, limit: number, callback: ICallback<IMMessage>) => {
    const msgTypes = ['custom']
