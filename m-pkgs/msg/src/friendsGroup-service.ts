...
export const FriendsGroupService = new Service()
...
/** 客服会话 */
export const useFriendsGroupSessions = () => {
    return FriendsGroupService.data
}

/** 获取消息列表分页器 */
export const useFriendsGroupList = (to: string, limit: number, callback: ICallback<IMMessage>) => {
