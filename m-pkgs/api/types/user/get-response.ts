...
export interface IUserGetResponse {
    ...
    /** 平台/商家详情 */
    "/v1/bc/admin/organization/detail": Required<operations["detailUsingGET_6"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 服务人员详情 */
    "/v1/bc/company/organization/worker/detail": Required<operations["detailUsingGET_7"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 被照护人详情 */
    "/v1/bc/app/patient/detail": Required<operations["getDetailUsingGET"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/public/article/detail": Required<operations["detailUsingGET_9"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/merchant/public/article/detail": Required<operations["detailUsingGET_10"]>['responses'][200]['content']['*/*']['data']

    /** categoryTree */
    "/v1/bc/server/public/article/category/tree": Required<operations["categoryTreeUsingGET_4"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/server/public/article/detail": Required<operations["detailUsingGET_11"]>['responses'][200]['content']['*/*']['data']

    /** 服务人员其他简历-店铺 */
    "/v1/bc/admin/resume/worker/company": Required<operations["workerDetailUsingGET"]>['responses'][200]['content']['*/*']['data']

    /** 服务人员简历详情 */
    "/v1/bc/admin/resume/worker/detail": Required<operations["detailUsingGET_12"]>['responses'][200]['content']['*/*']['data']

    /** 服务人员简历列表 */
    "/v1/bc/admin/resume/worker/list": Required<operations["listUsingGET_3"]>['responses'][200]['content']['*/*']['data']

    /** 简历详情 */
    "/v1/bc/app/resume/detail": Required<operations["detailUsingGET_13"]>['responses'][200]['content']['*/*']['data']

    /** 简历详情 */
    "/v1/bc/company/resume/detail": Required<operations["detailUsingGET_14"]>['responses'][200]['content']['*/*']['data']

    /** 简历详情 */
    "/v1/bc/company/resume/detail/worker": Required<operations["workerDetailUsingGET_1"]>['responses'][200]['content']['*/*']['data']

    /** 简历详情 */
    "/v1/bc/server/resume/detail": Required<operations["detailUsingGET_15"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/admin/role/detail": Required<operations["detailUsingGET_16"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 店铺名片详情 */
    "/v1/bc/company/shop/card/detail": Required<operations["detailUsingGET_17"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 初始化手续费合同-上线删除 */
    "/v1/bc/admin/shop/initCommissionData": Required<operations["initCommissionDataUsingGET"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 店铺详情 */
    "/v1/bc/company/shop/detail": Required<operations["detailUsingGET_18"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 机构设施详情 */
    "/v1/bc/company/shop/facility/detail": Required<operations["detailUsingGET_19"]>['responses'][200]['content']['*/*']['data']

    /** 店铺资质详情 */
    "/v1/bc/company/shop/license/detail": Required<operations["detailUsingGET_20"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 地址详情 */
    "/v1/bc/app/address/detail": Required<operations["detailUsingGET_21"]>['responses'][200]['content']['*/*']['data']

    /** 地址列表 */
    "/v1/bc/app/address/list": Required<operations["listUsingGET_4"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/admin/account/detail": Required<operations["detailUsingGET_22"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 获取用户详情 */
    "/v1/bc/app/user/detail": Required<operations["detailUsingGET_23"]>['responses'][200]['content']['*/*']['data']

    /** 银行卡详情 */
    "/v1/bc/server/workerBankCard/detail": Required<operations["detailUsingGET_24"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 人脸 + 身份证认证 */
    "/v1/bc/server/worker/certificateByCertifyId": Required<operations["certificateByCertifyIdUsingGET"]>['responses'][200]['content']['*/*']['data']

    /** 认证主页 */
    "/v1/bc/server/worker/certificationInfo": Required<operations["certificationInfoUsingGET"]>['responses'][200]['content']['*/*']['data']

    /** 获取详情 */
    "/v1/bc/server/worker/detail": Required<operations["detailUsingGET_25"]>['responses'][200]['content']['*/*']['data']

    /** 获取职业 */
    "/v1/bc/server/worker/getWorkerType": Required<operations["getWorkerTypeUsingGET_2"]>['responses'][200]['content']['*/*']['data']

    /** 详情 */
    "/v1/bc/admin/workerType/detail": Required<operations["detailUsingGET_26"]>['responses'][200]['content']['*/*']['data']
