...
export interface IImGetResponse {
    ...
    /** list */
    "/v1/bc/admin/qa_content/list": Required<operations["listUsingGET_1"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/app/qa_content/list": Required<operations["listUsingGET_2"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/admin/short_sentence/list": Required<operations["listUsingGET_3"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/app/short_sentence/list": Required<operations["listUsingGET_4"]>['responses'][200]['content']['*/*']['data']
