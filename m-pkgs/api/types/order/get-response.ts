...
export interface IOrderGetResponse {
    ...
    /** detail */
    "/v1/bc/server/aftersale/detail": Required<operations["detailUsingGET_3"]>['responses'][200]['content']['*/*']['data']

    /** record_list */
    "/v1/bc/server/aftersale/record_list": Required<operations["record_listUsingGET_2"]>['responses'][200]['content']['*/*']

    /** conditionCollection */
    "/v1/bc/admin/agency/conditionCollection": Required<operations["conditionCollectionUsingGET_1"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/admin/agency/detail": Required<operations["detailUsingGET_4"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/app/agency/detail": Required<operations["detailUsingGET_5"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/admin/coupon/detail": Required<operations["detailUsingGET_6"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/admin/estimate_question/detail": Required<operations["detailUsingGET_7"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/app/estimate_question/list": Required<operations["listUsingGET_3"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/admin/estimate_record/detail": Required<operations["detailUsingGET_8"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/admin/estimate_record/list": Required<operations["listUsingGET_4"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/admin/health/detail": Required<operations["detailUsingGET_9"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/app/health/detail": Required<operations["detailUsingGET_10"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 状态 */
    "/v1/bc/admin/job/status": Required<operations["listUsingGET_5"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/admin/product/detail": Required<operations["detailUsingGET_28"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/app/product/detail": Required<operations["detailUsingGET_29"]>['responses'][200]['content']['*/*']['data']
    ...
    /** detail */
    "/v1/bc/app/product_option/option_detail": Required<operations["detailUsingGET_30"]>['responses'][200]['content']['*/*']['data']

    /** detail */
    "/v1/bc/admin/product_stock/detail": Required<operations["detailUsingGET_31"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 模板列表 */
    "/v1/bc/admin/template/list": Required<operations["listUsingGET_6"]>['responses'][200]['content']['*/*']['data']
