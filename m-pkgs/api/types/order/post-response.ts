...
export interface IOrderPostResponse {
    ...
    /** pass */
    "/v1/bc/company/aftersale/pass": Required<operations["passUsingPOST_1"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 服务列表 */
    "/v1/bc/app/common/itemList": Required<operations["itemListUsingPOST"]>['responses'][200]['content']['*/*']
    ...
    /** sort */
    "/v1/bc/admin/estimate_question/sort": Required<operations["sortUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 工单列表 */
    "/v1/bc/admin/job/list": Required<operations["listUsingPOST_11"]>['responses'][200]['content']['*/*']
    ...
    /** 任务列表 */
    "/v1/bc/merchant/job/list": Required<operations["listUsingPOST_12"]>['responses'][200]['content']['*/*']
    ...
    /** 任务列表 */
    "/v1/bc/server/job/task": Required<operations["listUsingPOST_13"]>['responses'][200]['content']['*/*']

    /** save */
    "/v1/bc/server/category/save": Required<operations["saveUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 列表 */
    "/v1/bc/merchant/prepaid/list": Required<operations["listUsingPOST_14"]>['responses'][200]['content']['*/*']

    /** 修改/添加回访 */
    "/v1/bc/merchant/recall/add": Required<operations["addUsingPOST_6"]>['responses'][200]['content']['*/*']['data']

    /** 任务列表 */
    "/v1/bc/merchant/recall/list": Required<operations["listUsingPOST_15"]>['responses'][200]['content']['*/*']

    /** 删除 */
    "/v1/bc/merchant/recall/remove": Required<operations["removeUsingPOST_1"]>['responses'][200]['content']['*/*']['data']

    /** 任务列表 */
    "/v1/bc/server/recall/list": Required<operations["listUsingPOST_16"]>['responses'][200]['content']['*/*']
    ...
    /** 列表 */
    "/v1/bc/merchant/settle/list": Required<operations["listUsingPOST_17"]>['responses'][200]['content']['*/*']

    /** 删除 */
    "/v1/bc/admin/marketing/offline/delete": Required<operations["deleteUsingPOST_1"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 审核列表 */
    "/v1/bc/merchant/cancel/audit/order/list": Required<operations["listUsingPOST_18"]>['responses'][200]['content']['*/*']
    ...
    /** 订单列表 */
    "/v1/bc/admin/order/list": Required<operations["listUsingPOST_19"]>['responses'][200]['content']['*/*']
    ...
    /** 订单列表 */
    "/v1/bc/app/order/list": Required<operations["listUsingPOST_20"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 订单列表 */
    "/v1/bc/merchant/order/list": Required<operations["listUsingPOST_21"]>['responses'][200]['content']['*/*']
    ...
    /** 订单列表 */
    "/v1/product/admin/order/list": Required<operations["listUsingPOST_22"]>['responses'][200]['content']['*/*']
    ...
    /** 删除订单 */
    "/v1/product/app/order/delete": Required<operations["deleteUsingPOST_2"]>['responses'][200]['content']['*/*']
    ...
    /** 订单列表 */
    "/v1/product/merchant/order/list": Required<operations["listUsingPOST_23"]>['responses'][200]['content']['*/*']
    ...
    /** list */
    "/v1/bc/company/organization/order/list": Required<operations["listUsingPOST_24"]>['responses'][200]['content']['*/*']
    ...
    /** add */
    "/v1/bc/admin/product/add": Required<operations["addUsingPOST_7"]>['responses'][200]['content']['*/*']['data']
    ...
    /** del */
    "/v1/bc/admin/product/del": Required<operations["delUsingPOST_1"]>['responses'][200]['content']['*/*']['data']

    /** doAction */
    "/v1/bc/admin/product/doAction": Required<operations["doActionUsingPOST_10"]>['responses'][200]['content']['*/*']['data']

    /** 发布 */
    "/v1/bc/admin/product/doPublish": Required<operations["doPublishUsingPOST_3"]>['responses'][200]['content']['*/*']['data']

    /** edit */
    "/v1/bc/admin/product/edit": Required<operations["editUsingPOST_5"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/admin/product/list": Required<operations["listUsingPOST_25"]>['responses'][200]['content']['*/*']
    ...
    /** edit */
    "/v1/bc/admin/product_stock/edit": Required<operations["editUsingPOST_6"]>['responses'][200]['content']['*/*']['data']

    /** export */
    "/v1/bc/admin/product_stock/export": Required<operations["exportUsingPOST"]>['responses'][200]['content']

    /** list */
    "/v1/bc/admin/product_stock/list": Required<operations["listUsingPOST_26"]>['responses'][200]['content']['*/*']

    /** warningValueEdit */
    "/v1/bc/admin/product_stock/warning_value_edit": Required<operations["warningValueEditUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** list */
    "/v1/bc/admin/refund/list": Required<operations["listUsingPOST_27"]>['responses'][200]['content']['*/*']
