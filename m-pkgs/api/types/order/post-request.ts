...
export interface IOrderPostRequest {
    ...
    /** pass */
    "/v1/bc/company/aftersale/pass": Required<operations["passUsingPOST_1"]>['requestBody']['content']['application/json']
    ...
    /** 服务列表 */
    "/v1/bc/app/common/itemList": Required<operations["itemListUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** sort */
    "/v1/bc/admin/estimate_question/sort": Required<operations["sortUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 工单列表 */
    "/v1/bc/admin/job/list": Required<operations["listUsingPOST_11"]>['requestBody']['content']['application/json']
    ...
    /** 任务列表 */
    "/v1/bc/merchant/job/list": Required<operations["listUsingPOST_12"]>['requestBody']['content']['application/json']
    ...
    /** 任务列表 */
    "/v1/bc/server/job/task": Required<operations["listUsingPOST_13"]>['requestBody']['content']['application/json']

    /** save */
    "/v1/bc/server/category/save": Required<operations["saveUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 列表 */
    "/v1/bc/merchant/prepaid/list": Required<operations["listUsingPOST_14"]>['requestBody']['content']['application/json']

    /** 修改/添加回访 */
    "/v1/bc/merchant/recall/add": Required<operations["addUsingPOST_6"]>['requestBody']['content']['application/json']

    /** 任务列表 */
    "/v1/bc/merchant/recall/list": Required<operations["listUsingPOST_15"]>['requestBody']['content']['application/json']

    /** 删除 */
    "/v1/bc/merchant/recall/remove": Required<operations["removeUsingPOST_1"]>['requestBody']['content']['application/json']

    /** 任务列表 */
    "/v1/bc/server/recall/list": Required<operations["listUsingPOST_16"]>['requestBody']['content']['application/json']
    ...
    /** 列表 */
    "/v1/bc/merchant/settle/list": Required<operations["listUsingPOST_17"]>['requestBody']['content']['application/json']

    /** 删除 */
    "/v1/bc/admin/marketing/offline/delete": Required<operations["deleteUsingPOST_1"]>['requestBody']['content']['application/json']
    ...
    /** 审核列表 */
    "/v1/bc/merchant/cancel/audit/order/list": Required<operations["listUsingPOST_18"]>['requestBody']['content']['application/json']
    ...
    /** 订单列表 */
    "/v1/bc/admin/order/list": Required<operations["listUsingPOST_19"]>['requestBody']['content']['application/json']
    ...
    /** 订单列表 */
    "/v1/bc/app/order/list": Required<operations["listUsingPOST_20"]>['requestBody']['content']['application/json']
    ...
    /** 订单列表 */
    "/v1/bc/merchant/order/list": Required<operations["listUsingPOST_21"]>['requestBody']['content']['application/json']
    ...
    /** 订单列表 */
    "/v1/product/admin/order/list": Required<operations["listUsingPOST_22"]>['requestBody']['content']['application/json']
    ...
    /** 删除订单 */
    "/v1/product/app/order/delete": Required<operations["deleteUsingPOST_2"]>['requestBody']['content']['application/json']
    ...
    /** 订单列表 */
    "/v1/product/merchant/order/list": Required<operations["listUsingPOST_23"]>['requestBody']['content']['application/json']
    ...
    /** list */
    "/v1/bc/company/organization/order/list": Required<operations["listUsingPOST_24"]>['requestBody']['content']['application/json']
    ...
    /** add */
    "/v1/bc/admin/product/add": Required<operations["addUsingPOST_7"]>['requestBody']['content']['application/json']
    ...
    /** del */
    "/v1/bc/admin/product/del": Required<operations["delUsingPOST_1"]>['requestBody']['content']['application/json']

    /** doAction */
    "/v1/bc/admin/product/doAction": Required<operations["doActionUsingPOST_10"]>['requestBody']['content']['application/json']

    /** 发布 */
    "/v1/bc/admin/product/doPublish": Required<operations["doPublishUsingPOST_3"]>['requestBody']['content']['application/json']

    /** edit */
    "/v1/bc/admin/product/edit": Required<operations["editUsingPOST_5"]>['requestBody']['content']['application/json']

    /** list */
    "/v1/bc/admin/product/list": Required<operations["listUsingPOST_25"]>['requestBody']['content']['application/json']
    ...
    /** edit */
    "/v1/bc/admin/product_stock/edit": Required<operations["editUsingPOST_6"]>['requestBody']['content']['application/json']

    /** export */
    "/v1/bc/admin/product_stock/export": Required<operations["exportUsingPOST"]>['requestBody']['content']['application/json']

    /** list */
    "/v1/bc/admin/product_stock/list": Required<operations["listUsingPOST_26"]>['requestBody']['content']['application/json']
    ...
    /** list */
    "/v1/bc/admin/refund/list": Required<operations["listUsingPOST_27"]>['requestBody']['content']['application/json']
