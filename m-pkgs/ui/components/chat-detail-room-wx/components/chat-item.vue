<template>
    ...
    <!-- 正常聊天内容 -->
    <template v-else-if="props.item.type !== 'custom'">
        <view class="chat-item-box tn-flex-row" :class="[chatStyle]" :style="chatitemboxMarginStyle">
            ...
            <view class="main-box tn-flex-column" :style="mainboxMarginStyle">
                ...
                <view class="cnt-box tn-flex-row">
                    <BcTextMsg :item="item" class="bubble" :class="[cntStyle]" v-if="messageComponent === 'textMsg'"></BcTextMsg>
                    <BcImgMsg :item="item" class="bubble" :class="[cntStyle]" v-else-if="messageComponent === 'imageMsg'"></BcImgMsg>
                    <BcAudioMsg :item="item" type="room" class="bubble" :class="[cntStyle]" v-else-if="messageComponent === 'audioMsg'"></BcAudioMsg>
                    <BcOtherMsg :item="item" class="bubble" :class="[cntStyle]" v-else></BcOtherMsg>
...
import BcUserAvatar from '@/IndexPage/pages/chat/chat-page/components/user-avatar.vue'
import BcTextMsg from '@/IndexPage/pages/chat/chat-page/components/text-msg.vue'
import BcImgMsg from '@/IndexPage/pages/chat/chat-page/components/img-msg.vue'
import BcAudioMsg from '@/IndexPage/pages/chat/chat-page/components/audio-msg.vue'
import BcOtherMsg from '@/IndexPage/pages/chat/chat-page/components/other-msg.vue'
