<template>
    <view class="order-content">
        <view class="state-text-box" :class="staCls">
            <view class="state-title mattit">
                {{ osObj.statusName }}
            </view>
...
const staCls = computed(() => {
    // '待付款','待服务','待确认','待评价','已取消','待使用','已完成','待发货','待收货', '已收货', '云课堂交易成功'
    const stateArr = [65537, 131076, 131092, 131077, 196610, 262146, 131079, 196611, 131074, 131075, 196609, 196612]
    const colorArr = ['state1', 'state2', 'state2', 'state3', 'state4', 'state5', 'state6', 'state7', 'state8', 'state9', 'state7', 'state7']
