...
import shareView from '@/Create/components/shareorreportView/shareorreportView.vue'
...
const sharePoster = async () => {
    ...
    // 二维码链接图片
    let qrimg =  await getQrcode(`/Create/pages/videoPreview/videoPreview?videoId=${props.videoId}&videoPagetype=${props.videoPagetype}`).then((img:any)=>{
        return img
    })
...
const sharePage = () => {
    ...
    uni.share({
        ...
        miniProgram: {
            ...
            path: `/Create/pages/videoPreview/videoPreview?videoId=${props.videoId}&videoPagetype=${props.videoPagetype}`, //点击链接进入的页面
