        ...
        >
            <template #top>
                ...
                <view class="searchNav_box" v-if="data.searchIndex == 2">
                        ...
                        >
                            <TnTabsItem
                            v-for="(item, index) in data.searchTopNav"
                            :key="index"
                            :title="item.name"
            ...
            <view class="search_content" :style="'background:' + ((data.searchIndex == 1) ? '#fff' : '#F3F4F6')  +  ';'">
                <view class="happylike_List" v-if="data.showHappylikeBox">
                    <view class="happylike_scrool">
                        <view class="happylike_item" v-for="(item,index) in data.happylikeList" :key="index" @click="getHappyLikeSearch(item)">
                ...
                <template v-if="data.searchIndex == 1">
                    <view class="tag_list" v-if="data.showtag">
                        <view class="tag_list_top">
                            ...
                            <image
                                class="del_icon"
                                :src="getAssetsUrl('/leyou/icon/del_icon.svg')"
                                mode="scaleToFill"
                                @click="deltag"
                            />
                        </view>
                        <view class="tag_list_box">
                            <view class="tag_item" v-for="(item,index) in data.history" :key="item.id"  @click="searchinp(item)">
                                <image
                                    v-if="item.ishot == 1"
                                    class="tag_img"
                                    :src="getAssetsUrl('/leyou/icon/hot_icon.svg')"
                                    mode="scaleToFill"
                                />
                                {{ item.name }}
                            </view>
                    ...
                    <view class="tag_list">
                        ...
                        <view class="tag_list_box">
                            <view class="tag_item" v-for="(item,index) in data.recommend" :key="index" @click="toclassifyPage(item)">
                                <image
...
import { recommend, happylike, happysearch } from '@/api/user-api'
...
onMounted(() => {
    recommend({}).then((res:any)=>{
        data.recommend = res.filter((item:any) => {
