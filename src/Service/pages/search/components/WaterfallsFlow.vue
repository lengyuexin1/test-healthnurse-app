         ...
         <view>
             <view id="left" v-if="data.leftList.length">
                <template v-for="(item,index) in data.leftList" :key="index">
                    <view  class="wf-item">
                        <waterfallItem :isSmall="false" :direction="2" :item="item" @clickwaterItem="clickwaterItem"></waterfallItem>
                    </view>
                </template>
             </view>
         </view>
         ...
         <view>
             <view id="right" v-if="data.rightList.length">
                <template v-for="(item,index) in data.rightList" :key="index">
                    <view   class="wf-item">
                        <waterfallItem :isSmall="index == 0" :direction="2" :item="item" @clickwaterItem="clickwaterItem"></waterfallItem>
                    </view>
                </template>
             </view>
         </view>
