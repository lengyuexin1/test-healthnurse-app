         ...
         <view>
             <view id="left" v-if="data.leftList.length">
                <template v-for="(item,index) in data.leftList" :key="index">
                    <view  class="wf-item">
                        <WaterFallsItem :direction="1" :isSmall="false" :item="item" @clickwaterItem="clickwaterItem"></WaterFallsItem>
                    </view>
                </template>
             </view>
         </view>
         ...
         <view>
             <view id="right" v-if="data.rightList.length">
                <template v-for="(item,index) in data.rightList" :key="index">
                    <view   class="wf-item">
                        <WaterFallsItem :direction="2" :isSmall="index == 0" :item="item" @clickwaterItem="clickwaterItem"></WaterFallsItem>
                    </view>
                </template>
             </view>
         </view>
...
import WaterFallsItem from './WaterFalls-item.vue';
