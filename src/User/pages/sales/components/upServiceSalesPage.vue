            ...
            <view class="content">
                <view class="serbox">
                    ...
                    <view class="sercon row" v-if="data.serveDetail">
                        ...
                        />
                        <view class="serig">
                            <view class="sername u-line-1">
                                <text class="bold_text">{{data.serveDetail.title}}</text>
                                <text v-if="data.serveDetail.unitPrice">￥{{ (data.serveDetail.unitPrice / 100) }}</text>
                                <text v-else></text>
                            </view>
                            <view class="sersub u-line-1" v-if="data.serveDetail.subtitle">{{data.serveDetail.subtitle}}</view>
                            <view class="sersub space" v-else>x{{data.serveDetail.quantity}}</view>
                            <view class="serprice">￥{{(data.serveDetail.price / 100)}}</view>
                        </view>
                    </view>
                </view>
                <template>
                    <view class="some">
                        ...
                        <view class="salebox">
                            ...
                            <template v-if="data.serveDetail">
...
const addAftersale = () => {
    ...
    let saleData = {
        ...
        refund: data.refund ? (data.refund * 100) : data.serveDetail.price,
