<template>
    <view class="chat-item-box tn-flex-row" :class="[chatStyle]" :style="chatitemboxMarginStyle">
        <UserAvatar :is-robot="isRobot" :avatar="user.avatar"></UserAvatar>
        ...
        <view class="main-box tn-flex-column" :style="mainboxMarginStyle">
            ...
            <view class="cnt-box tn-flex-row">
                <TextMsg :item="item" :class="[cntStyle]" v-if="messageComponent === 'textMsg'"></TextMsg>
                <ImgMsg :item="item" :class="[cntStyle]" v-else-if="messageComponent === 'imageMsg'"></ImgMsg>
                <AudioMsg :item="item" :class="[cntStyle]" v-else-if="messageComponent === 'audioMsg'"></AudioMsg>
                <OtherMsg :item="item" :class="[cntStyle]" v-else></OtherMsg>
...
import TextMsg from '../components/text-msg.vue'
import ImgMsg from '../components/img-msg.vue'
import AudioMsg from '../components/audio-msg.vue'
import OtherMsg from '../components/other-msg.vue'
