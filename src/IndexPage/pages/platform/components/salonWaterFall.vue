             ...
             <view id="left" v-if="data.leftList.length">
                <template v-for="(item,index) in data.leftList" :key="item.id">
                    <view  class="wf-item">
                        ...
                        <salonItem :direction="1" :isSmall="false" :item="item" @clickwaterItem="clickwaterItem"></salonItem>
                    </view>
                </template>
             </view>
         </view>
         ...
         <view>
             <view id="right" v-if="data.rightList.length">
                <template v-for="(item,index) in data.rightList" :key="item.id">
                    <view   class="wf-item">
                        <!-- :is_statistics="is_statistics" -->
                        <salonItem :direction="2" :isSmall="index == 0" :item="item" @clickwaterItem="clickwaterItem"></salonItem>
                    </view>
                </template>
             </view>
         </view>
...
import salonItem from './salon-item.vue'
