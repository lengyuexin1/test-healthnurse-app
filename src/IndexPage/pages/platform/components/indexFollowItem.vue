<template>
    <view class="WaterFall_item" :class="{ 'is_left' : props.direction == 1 , 'is_right' : props.direction == 2 }" @click="todetail(item)">
        ...
        <view class="WaterFall_text_box">
            <view class="WaterFall_text_title">{{ item.title }}</view>
            <view class="WaterFall_text_bottom">
                <view class="WaterFall_text_author">
                    <image
                        v-if="item.accountThumb || item.ccountThumb"
                        class="WaterFall_text_author_img"
                        :src="item.accountThumb ? item.accountThumb : item.ccountThumb"
                        mode="aspectFill"
                    />
                    <view class="WaterFall_author_name_box">
                        <view class="WaterFall_author_name">{{ item.accountName ? item.accountName : item.createdName }}</view>
                    </view>
                </view>
                <view></view>
            </view>
