        ...
        <view class="calerbox">
            <view class="calecon">
                <view class="caleli row i-center j-between">
                    ...
                    <view class="caleinp">
                        <input v-model="formDate.name" class="inpbox" type="text" :maxlength="10" placeholder="请输入通知人名称">
                    </view>
                </view>
                <view class="caleli row i-center j-between">
                ...
                <view class="caleli row i-center j-between">
                    ...
                    <view class="caleinp row i-center">
                        ...
                        <TnInput v-model="formDate.code" class="inpbox" type="number" maxlength="11" placeholder="请输入手机号码">
                            <template #suffix>
                                <view class="daojs" v-if="showCode">
                                    <TnCountDown ref="countDown" :time="59" @end="endTime" :show-hour="false"
                                        :show-minute="false" />
                                </view>
                                <TnButton v-if="!showCode" text-color="#fff" bg-color="#29C86F" @tap="getCode">{{ tips }}
                                </TnButton>
                            </template>
                        </TnInput>
                ...
                <view class="fotbtn row i-center j-between">
                    <view class="fotdel" v-if="receiverId">
                        <TnButton border-color="#E3E3E3" text-color="#fff" font-size="32rpx" width="100%" height="90"
                            bg-color="#ff4d4e" @click="delshow = true">删除</TnButton>
                    </view>
                    <view class="fotsure">
                        <TnButton border-color="#E3E3E3" text-color="#fff" font-size="32rpx" width="100%" height="90"
                            bg-color="#29C86F" @click="submit">保存</TnButton>
                    </view>
                </view>
                <u-safe-bottom slot="bottom"></u-safe-bottom>
            </view>
        ...
        <TnPopup v-model="delshow">
            ...
            <view class="towBtn">
                <TnButton border-color="#E3E3E3" text-color="#fff" font-size="32rpx" width="40%" height="60"
                    bg-color="#ff4d4e" @click="removeCaler">确定</TnButton>
                <TnButton border-color="#E3E3E3" text-color="#fff" font-size="32rpx" width="40%" height="60"
                    bg-color="#29C86F" @click="delshow = false">取消</TnButton>
            </view>
        </TnPopup>
