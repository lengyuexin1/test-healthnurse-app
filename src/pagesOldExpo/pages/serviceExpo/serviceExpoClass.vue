            ...
            <view class="page_content">
                <view class="zone_box">
                    <view class="zone_list" >
                        <view class="zone_item" v-for="(item, index) in data.categoryList" :key="index" @click="toClassPage(item)" >
                            <image
                                class="zone_img"
                ...
                <view class="live_swiper">
                    ...
                    <view class="swiper_sign_box">
                        ...
                        <view class="sign_item" :class="{ 'is_sign': signIndex == data.swiperIndex }" v-for="(signItem, signIndex) in 1"></view>
                    </view>
                </view>
...
import { gotoServiceExpoClass, gotonewProduct, gotoDiscussDetail, gotoAllZone, gotoAllClass, gotoClassItemPage, gotoServiceStore, gotosearch } from '@/routes/service-routes'
