...
export const setPageBank = (req: any) => {
    return http.get('api/order/v1/bc/public/app/adorn/page/detail', { page: req })
}

// banner列表
export const bannerList = (req: any) => {
    return http.post('api/order/v1/bc/public/app/adorn/banner/list', req)
}

// 导航栏
export const columnList = (req: any) => {
    return http.post('api/order/v1/bc/public/app/adorn/column/list', req)
}

// 装饰类目详情
export const columnDetail = (req: any) => {
    return http.get('api/order/v1/bc/public/app/adorn/column/detail', { id: req })
}
