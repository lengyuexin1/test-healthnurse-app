    ...
    <view class="container">
        <div class="footer">
			<div class="fotbox row">
                ...
                <div class="fotbtn editbtn" v-if="actionList.includes('delay_receive')" @click="operate('delay_receive')">
					<view >延迟收货</view>
				</div>
				...
				<div class="fotbtn btn" v-if="actionList.includes('view_express') " @click="operate('view_express')">
					<view >查看物流</view>
				</div>

				<div class="fotbtn btn" v-if="actionList.includes('confirm_receive')" @click="operate('confirm_receive')">
					<view >确认收货</view>
				</div>

				<div class="fotbtn btn" v-if="actionList.includes('comment')" @click="operate('comment')">
					<view >去评价</view>
				</div>

                <div class="fotbtn btn" v-if="actionList.includes('pay')" @click="operate('pay')">
					<view >立即支付</view>
				</div>
