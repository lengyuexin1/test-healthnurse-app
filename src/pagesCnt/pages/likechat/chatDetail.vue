...
const sharePage = () => {
    ...
    uni.share({
        ...
        miniProgram: {
            ...
            path: `/pagesCnt/pages/likechat/chatDetail?id=${data.chatDetail.id}`, //点击链接进入的页面
...
onShareAppMessage((res:any)=>{
    ...
    return {
        ...
        path: `/pagesCnt/pages/likechat/chatDetail?id=${data.chatDetail.id}`,
    }
})
//#endif
...
const sharePoster = async () => {
    ...
    // 二维码链接图片
    let qrimg =  await getQrcode(`/pagesCnt/pages/likechat/chatDetail?id=${data.chatDetail.id}`).then((img:any)=>{
        return img
    })
