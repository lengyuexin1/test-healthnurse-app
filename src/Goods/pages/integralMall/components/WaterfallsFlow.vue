         ...
         <view>
             <view id="left" v-if="data.leftList.length">
                <template v-for="(item,index) in data.leftList" :key="index">
                    <view  class="wf-item">
                        <GoodsItemVue :direction="2" :item="item" @clickwaterItem="clickwaterItem"></GoodsItemVue>
                    </view>
                </template>
             </view>
         </view>
         ...
         <view>
             <view id="right" v-if="data.rightList.length">
                <template v-for="(item,index) in data.rightList" :key="index">
                    <view   class="wf-item">
                        <GoodsItemVue :isSmall="index == 0" :direction="2" :item="item" @clickwaterItem="clickwaterItem"></GoodsItemVue>
                    </view>
                </template>
             </view>
         </view>
