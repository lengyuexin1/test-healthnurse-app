<template>
        ...
        methods: {
            ...
            trimImage() {
                ...
                query.select(".body").boundingClientRect((data) => {
                    ...
                    const tx = (bw - tw) / 2
                    const ty = (bh - th) / 2
                    const ax = tx - this.frame.left + (this.frame.left - this.image.left) * (1 - scale)
                    const ay = ty - this.frame.top + (this.frame.top - this.image.top) * (1 - scale)
                    this.frame.width = tw
                    this.frame.height = th
                    this.frame.left = tx
                    this.frame.top = ty
    ...
    <style scoped>
    .ksp-image-cutter{position:absolute;width:100%;height:100%;top:0;left:0;z-index:1000}.toolbar{position:absolute;width:100%;height:100upx;left:0upx;bottom:0upx;box-sizing:border-box;border-bottom:1px solid #c0c0c0;background:#f8f8f8}.btn-cancel{position:absolute;left:100upx;top:12upx;font-size:30upx;line-height:30upx;padding:20upx;color:#333}.btn-ok{position:absolute;right:100upx;top:12upx;font-size:30upx;line-height:30upx;padding:20upx;color:#333}.body{position:absolute;left:0upx;right:0upx;top:0upx;bottom:100upx;background:black;overflow:hidden}.mask{position:absolute;left:0upx;right:0upx;top:0upx;bottom:0upx;background:black;opacity:.4}.plank{position:absolute;left:0upx;right:0upx;top:0upx;bottom:0upx}.image{position:absolute}.frame{position:absolute}.canvas{position:absolute;display:block;left:0;top:0}.rect{position:absolute;left:-2px;top:-2px;width:100%;height:100%;border:2px solid white}.line-one{position:absolute;width:100%;height:1px;background:white;left:0;top:33.3%}.line-two{position:absolute;width:100%;height:1px;background:white;left:0;top:66.7%}.line-three{position:absolute;width:1px;height:100%;background:white;top:0;left:33.3%}.line-four{position:absolute;width:1px;height:100%;background:white;top:0;left:66.7%}.frame-left{position:absolute;height:100%;width:8px;left:-4px;top:0}.frame-right{position:absolute;height:100%;width:8px;right:-4px;top:0}.frame-top{position:absolute;width:100%;height:8px;top:-4px;left:0}.frame-bottom{position:absolute;width:100%;height:8px;bottom:-4px;left:0}.frame-left-top{position:absolute;width:20px;height:20px;left:-6px;top:-6px;border-left:4px solid red;border-top:4px solid red}.frame-left-bottom{position:absolute;width:20px;height:20px;left:-6px;bottom:-6px;border-left:4px solid red;border-bottom:4px solid red}.frame-right-top{position:absolute;width:20px;height:20px;right:-6px;top:-6px;border-right:4px solid red;border-top:4px solid red}.frame-right-bottom{position:absolute;width:20px;height:20px;right:-6px;bottom:-6px;border-right:4px solid red;border-bottom:4px solid red}
    </style>
