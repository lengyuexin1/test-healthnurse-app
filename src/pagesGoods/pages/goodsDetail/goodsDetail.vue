<template>
    <view class="wrap" style="height: 100vh" v-if="showPage">
        ...
        >
            ...
            <view class="serve-info" id="serveBox">
                <view class="info-about row j-between">
                ...
                <view class="optbox">
                    <view class="optit">商品规格</view>
                    <view class="godinfo row">
                        <view class="surelef">发货</view>
