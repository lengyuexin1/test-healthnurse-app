...
export interface ISettlementPostRequest {
    ...
    /** 保证金退还列表 */
    "/v1/bc/admin/account/marginRefundList": Required<operations["marginRefundListUsingPOST"]>['requestBody']['content']['application/json']

    /** 测试专用-收款单 */
    "/v1/bc/admin/account/receipt": Required<operations["receiptUsingPOST"]>['requestBody']['content']['application/json']

    /** 测试专用-收款退款单v2 */
    "/v1/bc/admin/account/receiptRefundV2": Required<operations["receiptUsingPOST_1"]>['requestBody']['content']['application/json']

    /** 测试专用-收款单v2 */
    "/v1/bc/admin/account/receiptV2": Required<operations["receiptUsingPOST_2"]>['requestBody']['content']['application/json']
    ...
    /** 提现列表 */
    "/v1/bc/company/cpcn/getCompanyList": Required<operations["getCompanyListUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 发票识别 */
    "/v1/bc/admin/kingdee/Check": Required<operations["CheckUsingPOST"]>['parameters']['query']

    /** api116 */
    "/v1/bc/admin/kingdee/api116": Required<operations["api116UsingPOST"]>['requestBody']

    /** api2 */
    "/v1/bc/admin/kingdee/api2": Required<operations["api2UsingPOST"]>['requestBody']['content']['application/json']

    /** createInvoice */
    "/v1/bc/admin/kingdee/createInvoice": Required<operations["createInvoiceUsingPOST"]>['requestBody']['content']['application/json']

    /** createResult */
    "/v1/bc/admin/kingdee/createResult": Required<operations["createResultUsingPOST_1"]>['parameters']['query']

    /** getInvoiceToken */
    "/v1/bc/admin/kingdee/invoiceApi": Required<operations["getInvoiceTokenUsingPOST"]>['requestBody']['content']['application/json']

    /** push */
    "/v1/bc/admin/kingdee/push": Required<operations["pushUsingPOST"]>['requestBody']['content']['application/json']

    /** query */
    "/v1/bc/admin/kingdee/query": Required<operations["queryUsingPOST"]>['requestBody']['content']['application/json']

    /** save */
    "/v1/bc/admin/kingdee/save": Required<operations["saveUsingPOST"]>['requestBody']['content']['application/json']

    /** syncCommission */
    "/v1/bc/admin/kingdee/syncCommission": Required<operations["syncCommissionUsingPOST"]>['requestBody']['content']['application/json']

    /** syncCpcnCommission */
    "/v1/bc/admin/kingdee/syncCpcnCommission": Required<operations["syncCpcnCommissionUsingPOST"]>['requestBody']

    /** syncCpcnCommissionByTradeId */
    "/v1/bc/admin/kingdee/syncCpcnCommissionByTradeId": Required<operations["syncCpcnCommissionByTradeIdUsingPOST"]>['parameters']['query']

    /** syncInvoice */
    "/v1/bc/admin/kingdee/syncInvoice": Required<operations["syncInvoiceUsingPOST"]>['parameters']['query']

    /** 同步金蝶数据 */
    "/v1/bc/admin/kingdee/syncKingData": Required<operations["getKingdeeInvoiceListUsingPOST"]>['requestBody']

    /** 同步营销费用到金蝶应收单 */
    "/v1/bc/admin/kingdee/syncPlatformDiscountToKingdeePayable": Required<operations["syncPlatformDiscountToKingdeePayableUsingPOST"]>['parameters']['query']

    /** view */
    "/v1/bc/admin/kingdee/view": Required<operations["viewUsingPOST"]>['requestBody']['content']['application/json']

    /** 设置商品税收编码 */
    "/v1/bc/company/kingdee/setProductTaxCode": Required<operations["setProductTaxCodeUsingPOST"]>['requestBody']['content']['application/json']

    /** 税收分类编码列表 */
    "/v1/bc/company/kingdee/taxCodeList": Required<operations["taxCodeListUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 发票云回调 */
    "/v1/bc/public/invoiceCallback": Required<operations["invoiceCallbackUsingPOST"]>['requestBody']['content']['application/json']
