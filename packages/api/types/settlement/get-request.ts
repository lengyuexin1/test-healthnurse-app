...
export interface ISettlementGetRequest {
    ...
    /** 初始化数据，财务自动化上线之后删除 */
    "/v1/bc/admin/account/initData": Required<operations["initDataUsingGET"]>['parameters']['query']
    ...
    /** 是否满足保证金退还条件 */
    "/v1/bc/company/account/canRefundMargin": Required<operations["canRefundMarginUsingGET"]>['parameters']['query']

    /** 获取保证金账户 */
    "/v1/bc/company/account/getMarginAccount": Required<operations["getMarginAccountUsingGET"]>['parameters']['query']

    /** 保证金账单列表 */
    "/v1/bc/company/account/marginOrderList": Required<operations["getMarginOrderListUsingGET"]>['parameters']['query']

    /** 保证金退还申请 */
    "/v1/bc/company/account/marginRefundApply": Required<operations["marginRefundApplyUsingGET"]>['parameters']['query']
    ...
    /** 获取账户基本信息和余额 */
    "/v1/bc/company/cpcn/getShopSimpleInfoAndBalance": Required<operations["getShopSimpleInfoAndBalanceUsingGET"]>['parameters']['query']
    ...
    /** 提现 */
    "/v1/bc/company/cpcn/withdrawal": Required<operations["withdrawalUsingGET"]>['parameters']['query']
    ...
    /** 订单发票开票-发票云 */
    "/v1/bc/company/invoice/autoCreate": Required<operations["autoCreateUsingGET"]>['parameters']['query']

    /** 查询发票云开票结果 */
    "/v1/bc/company/invoice/createResult": Required<operations["createResultUsingGET"]>['parameters']['query']
    ...
    /** saveCustomer */
    "/v1/bc/admin/kingdee/saveCustomer": Required<operations["saveCustomerUsingGET"]>['parameters']['query']

    /** 同步供应商 */
    "/v1/bc/admin/kingdee/saveSupplier": Required<operations["saveSupplierUsingGET"]>['parameters']['query']

    /** 同步手续费账单到金蝶应收单 */
    "/v1/bc/admin/kingdee/syncCommissionToKingdeeReceivable": Required<operations["syncCommissionToKingdeeReceivableUsingGET"]>['parameters']['query']

    /** 同步供应商 */
    "/v1/bc/admin/kingdee/updateInvoiceFromServer": Required<operations["updateInvoiceFromServerUsingGET"]>['parameters']['query']

    /** 获取发票云账户 */
    "/v1/bc/company/kingdee/getInvoiceAccount": Required<operations["getInvoiceAccountUsingGET"]>['parameters']['query']
    ...
    /** 发票云回调 */
    "/v1/bc/public/invoiceCallback": Required<operations["invoiceCallbackUsingGET"]>['parameters']['query']
