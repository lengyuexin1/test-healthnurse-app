...
export interface ISettlementPostResponse {
    ...
    /** 保证金退还列表 */
    "/v1/bc/admin/account/marginRefundList": Required<operations["marginRefundListUsingPOST"]>['responses'][200]['content']['*/*']

    /** 测试专用-收款单 */
    "/v1/bc/admin/account/receipt": Required<operations["receiptUsingPOST"]>['responses'][200]['content']

    /** 测试专用-收款退款单v2 */
    "/v1/bc/admin/account/receiptRefundV2": Required<operations["receiptUsingPOST_1"]>['responses'][200]['content']

    /** 测试专用-收款单v2 */
    "/v1/bc/admin/account/receiptV2": Required<operations["receiptUsingPOST_2"]>['responses'][200]['content']
    ...
    /** 提现列表 */
    "/v1/bc/company/cpcn/getCompanyList": Required<operations["getCompanyListUsingPOST"]>['responses'][200]['content']['*/*']
    ...
    /** 发票识别 */
    "/v1/bc/admin/kingdee/Check": Required<operations["CheckUsingPOST"]>['responses'][200]['content']['*/*']

    /** api116 */
    "/v1/bc/admin/kingdee/api116": Required<operations["api116UsingPOST"]>['responses'][200]['content']['*/*']

    /** api2 */
    "/v1/bc/admin/kingdee/api2": Required<operations["api2UsingPOST"]>['responses'][200]['content']['*/*']

    /** createInvoice */
    "/v1/bc/admin/kingdee/createInvoice": Required<operations["createInvoiceUsingPOST"]>['responses'][200]['content']['*/*']

    /** createResult */
    "/v1/bc/admin/kingdee/createResult": Required<operations["createResultUsingPOST_1"]>['responses'][200]['content']['*/*']

    /** getInvoiceToken */
    "/v1/bc/admin/kingdee/invoiceApi": Required<operations["getInvoiceTokenUsingPOST"]>['responses'][200]['content']['*/*']

    /** push */
    "/v1/bc/admin/kingdee/push": Required<operations["pushUsingPOST"]>['responses'][200]['content']['*/*']

    /** query */
    "/v1/bc/admin/kingdee/query": Required<operations["queryUsingPOST"]>['responses'][200]['content']['*/*']

    /** save */
    "/v1/bc/admin/kingdee/save": Required<operations["saveUsingPOST"]>['responses'][200]['content']['*/*']

    /** syncCommission */
    "/v1/bc/admin/kingdee/syncCommission": Required<operations["syncCommissionUsingPOST"]>['responses'][200]['content']

    /** syncCpcnCommission */
    "/v1/bc/admin/kingdee/syncCpcnCommission": Required<operations["syncCpcnCommissionUsingPOST"]>['responses'][200]['content']

    /** syncCpcnCommissionByTradeId */
    "/v1/bc/admin/kingdee/syncCpcnCommissionByTradeId": Required<operations["syncCpcnCommissionByTradeIdUsingPOST"]>['responses'][200]['content']

    /** syncInvoice */
    "/v1/bc/admin/kingdee/syncInvoice": Required<operations["syncInvoiceUsingPOST"]>['responses'][200]['content']

    /** 同步金蝶数据 */
    "/v1/bc/admin/kingdee/syncKingData": Required<operations["getKingdeeInvoiceListUsingPOST"]>['responses'][200]['content']

    /** 同步营销费用到金蝶应收单 */
    "/v1/bc/admin/kingdee/syncPlatformDiscountToKingdeePayable": Required<operations["syncPlatformDiscountToKingdeePayableUsingPOST"]>['responses'][200]['content']

    /** view */
    "/v1/bc/admin/kingdee/view": Required<operations["viewUsingPOST"]>['responses'][200]['content']['*/*']

    /** 设置商品税收编码 */
    "/v1/bc/company/kingdee/setProductTaxCode": Required<operations["setProductTaxCodeUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** 税收分类编码列表 */
    "/v1/bc/company/kingdee/taxCodeList": Required<operations["taxCodeListUsingPOST"]>['responses'][200]['content']['*/*']
    ...
    /** 发票云回调 */
    "/v1/bc/public/invoiceCallback": Required<operations["invoiceCallbackUsingPOST"]>['responses'][200]['content']['*/*']
