...
export interface IUserPostRequest {
    ...
    /** APP管理员登录 */
    "/v1/bc/company/admin/appAccountLogin": Required<operations["appAccountLoginUsingPOST"]>['requestBody']['content']['application/json']

    /** APP管理员登录(无应用编码) */
    "/v1/bc/company/admin/appLogin": Required<operations["appLoginUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 平台端管理员登录 */
    "/v1/bc/company/admin/platformAccountLogin": Required<operations["platformAccountLoginUsingPOST"]>['requestBody']['content']['application/json']

    /** 平台端管理员登录(无应用编码) */
    "/v1/bc/company/admin/platformLogin": Required<operations["platformLoginUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 统一免密登录 */
    "/v1/bc/company/admin/uniAutoLogin": Required<operations["uniAutoLoginUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 活动提交 */
    "/v1/bc/company/operation/activity/auditParticipation": Required<operations["auditParticipationUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 服务人员服务时长统计 */
    "/v1/bc/admin/organization/worker/onlineStatus": Required<operations["onlineStatusUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 服务人员服务时长统计 */
    "/v1/bc/server/organization/worker/onlineStatus": Required<operations["onlineStatusUsingPOST_1"]>['requestBody']['content']['application/json']
    ...
    /** 关联模板 */
    "/v1/bc/admin/role/im_template/bind": Required<operations["bindUsingPOST"]>['requestBody']['content']['application/json']
    ...
    /** 搜索符合条件的服务人员 */
    "/v1/bc/company/shop/searchShopWorker": Required<operations["searchShopWorkerUsingPOST"]>['requestBody']['content']['application/json']
