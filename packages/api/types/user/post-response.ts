...
export interface IUserPostResponse {
    ...
    /** APP管理员登录 */
    "/v1/bc/company/admin/appAccountLogin": Required<operations["appAccountLoginUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** APP管理员登录(无应用编码) */
    "/v1/bc/company/admin/appLogin": Required<operations["appLoginUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 平台端管理员登录 */
    "/v1/bc/company/admin/platformAccountLogin": Required<operations["platformAccountLoginUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** 平台端管理员登录(无应用编码) */
    "/v1/bc/company/admin/platformLogin": Required<operations["platformLoginUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 统一免密登录 */
    "/v1/bc/company/admin/uniAutoLogin": Required<operations["uniAutoLoginUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 活动提交 */
    "/v1/bc/company/operation/activity/auditParticipation": Required<operations["auditParticipationUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 服务人员服务时长统计 */
    "/v1/bc/admin/organization/worker/onlineStatus": Required<operations["onlineStatusUsingPOST"]>['responses'][200]['content']['*/*']
    ...
    /** 服务人员服务时长统计 */
    "/v1/bc/server/organization/worker/onlineStatus": Required<operations["onlineStatusUsingPOST_1"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 关联模板 */
    "/v1/bc/admin/role/im_template/bind": Required<operations["bindUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 搜索符合条件的服务人员 */
    "/v1/bc/company/shop/searchShopWorker": Required<operations["searchShopWorkerUsingPOST"]>['responses'][200]['content']['*/*']
