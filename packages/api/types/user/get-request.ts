...
export interface IUserGetRequest {
    ...
    /** 头条 */
    "/v1/bc/public/ad_store/tt/listener": Required<operations["ttListenerUsingGET"]>['parameters']['query']
    ...
    /** 评论详情 */
    "/v1/bc/api/comment/comment/details": Required<operations["commentDetailsUsingGET"]>['parameters']['query']
    ...
    /** 活动详情 */
    "/v1/bc/company/operation/activity/detail": Required<operations["detailUsingGET_6"]>['parameters']['query']

    /** history */
    "/history": Required<operations["historyUsingGET"]>['parameters']['query']

    /** 试运营进度详情 */
    "/v1/bc/admin/operation/schedule/detail": Required<operations["detailUsingGET_7"]>['parameters']['query']

    /** 试运营进度定时任务测试 */
    "/v1/bc/admin/operation/schedule/timerTaskTest": Required<operations["timerTaskTestUsingGET"]>['parameters']['query']

    /** 更新店铺营业状态测试 */
    "/v1/bc/admin/operation/schedule/updateBusinessStatusTest": Required<operations["updateBusinessStatusTestUsingGET"]>['parameters']['query']

    /** 更新试运营进度测试 */
    "/v1/bc/admin/operation/schedule/updateOperationStatusTest": Required<operations["updateOperationStatusTestUsingGET"]>['parameters']['query']

    /** 试运营进度详情 */
    "/v1/bc/company/operation/schedule/detail": Required<operations["detailUsingGET_8"]>['parameters']['query']
    ...
    /** 平台/商家详情 */
    "/v1/bc/admin/organization/detail": Required<operations["detailUsingGET_9"]>['parameters']['query']
    ...
    /** timerTaskTest */
    "/v1/bc/admin/organization/timerTaskTest": Required<operations["timerTaskTestUsingGET_1"]>['parameters']['query']
    ...
    /** 服务人员详情 */
    "/v1/bc/company/organization/worker/detail": Required<operations["detailUsingGET_10"]>['parameters']['query']
    ...
    /** 被照护人详情 */
    "/v1/bc/app/patient/detail": Required<operations["getDetailUsingGET_1"]>['parameters']['query']

    /** 被照护人列表 */
    "/v1/bc/app/patient/list": Required<operations["getListUsingGET_1"]>['parameters']['query']

    /** 广告-APP启动 */
    "/v1/bc/public/ad/startup": Required<operations["startupUsingGET"]>['parameters']['query']

    /** categoryTree */
    "/v1/bc/public/article/category/tree": Required<operations["categoryTreeUsingGET_1"]>['parameters']['query']

    /** detail */
    "/v1/bc/public/article/detail": Required<operations["detailUsingGET_12"]>['parameters']['query']

    /** 个体创作推荐 */
    "/v1/bc/public/guess_articles": Required<operations["getGuessContentArticlesUsingGET"]>['parameters']['query']
    ...
    /** detail */
    "/v1/bc/merchant/public/article/detail": Required<operations["detailUsingGET_13"]>['parameters']['query']

    /** categoryTree */
    "/v1/bc/server/public/article/category/tree": Required<operations["categoryTreeUsingGET_4"]>['parameters']['query']

    /** detail */
    "/v1/bc/server/public/article/detail": Required<operations["detailUsingGET_14"]>['parameters']['query']

    /** 服务人员其他简历-店铺 */
    "/v1/bc/admin/resume/worker/company": Required<operations["workerDetailUsingGET"]>['parameters']['query']

    /** 服务人员简历详情 */
    "/v1/bc/admin/resume/worker/detail": Required<operations["detailUsingGET_15"]>['parameters']['query']

    /** 服务人员简历列表 */
    "/v1/bc/admin/resume/worker/list": Required<operations["listUsingGET_3"]>['parameters']['query']

    /** 简历详情 */
    "/v1/bc/app/resume/detail": Required<operations["detailUsingGET_16"]>['parameters']['query']

    /** 简历详情 */
    "/v1/bc/company/resume/detail": Required<operations["detailUsingGET_17"]>['parameters']['query']

    /** 简历详情 */
    "/v1/bc/company/resume/detail/worker": Required<operations["workerDetailUsingGET_1"]>['parameters']['query']

    /** 简历详情 */
    "/v1/bc/server/resume/detail": Required<operations["detailUsingGET_18"]>['parameters']['query']

    /** detail */
    "/v1/bc/admin/role/detail": Required<operations["detailUsingGET_19"]>['parameters']['query']

    /** getMenuIdsByRoleId */
    "/v1/bc/admin/role/menu/list": Required<operations["getMenuIdsByRoleIdUsingGET"]>['parameters']['query']

    /** 模板列表 */
    "/v1/bc/admin/role/im_template/all": Required<operations["allUsingGET_1"]>['parameters']['query']

    /** 店铺名片审核详情 */
    "/v1/bc/admin/shop/card/auditDetail": Required<operations["auditDetailUsingGET"]>['parameters']['query']

    /** 店铺名片详情 */
    "/v1/bc/company/shop/card/detail": Required<operations["detailUsingGET_20"]>['parameters']['query']
    ...
    /** 店铺详情 */
    "/v1/bc/company/shop/detail": Required<operations["detailUsingGET_21"]>['parameters']['query']
    ...
    /** 机构设施详情 */
    "/v1/bc/company/shop/facility/detail": Required<operations["detailUsingGET_22"]>['parameters']['query']

    /** 店铺资质详情 */
    "/v1/bc/company/shop/license/detail": Required<operations["detailUsingGET_23"]>['parameters']['query']
    ...
    /** worker */
    "/v1/bc/admin/test/worker": Required<operations["workerUsingGET"]>['parameters']['query']
    ...
    /** 地址详情 */
    "/v1/bc/app/address/detail": Required<operations["detailUsingGET_24"]>['parameters']['query']

    /** 地址列表 */
    "/v1/bc/app/address/list": Required<operations["listUsingGET_4"]>['parameters']['query']

    /** detail */
    "/v1/bc/admin/account/detail": Required<operations["detailUsingGET_25"]>['parameters']['query']
    ...
    /** 用户实名认证 */
    "/v1/bc/app/user/certificateByCertifyId": Required<operations["certificateByCertifyIdUsingGET"]>['parameters']['query']

    /** 获取用户详情 */
    "/v1/bc/app/user/detail": Required<operations["detailUsingGET_26"]>['parameters']['query']

    /** 银行卡详情 */
    "/v1/bc/server/workerBankCard/detail": Required<operations["detailUsingGET_27"]>['parameters']['query']
    ...
    /** 人脸 + 身份证认证 */
    "/v1/bc/server/worker/certificateByCertifyId": Required<operations["certificateByCertifyIdUsingGET_1"]>['parameters']['query']

    /** 认证主页 */
    "/v1/bc/server/worker/certificationInfo": Required<operations["certificationInfoUsingGET"]>['parameters']['query']

    /** 获取详情 */
    "/v1/bc/server/worker/detail": Required<operations["detailUsingGET_28"]>['parameters']['query']

    /** 获取职业 */
    "/v1/bc/server/worker/getWorkerType": Required<operations["getWorkerTypeUsingGET_2"]>['parameters']['query']

    /** 详情 */
    "/v1/bc/admin/workerType/detail": Required<operations["detailUsingGET_29"]>['parameters']['query']
    ...
    /** 获取类目所有工种 */
    "/v1/bc/company/workerType/commuteList": Required<operations["commuteListUsingGET"]>['parameters']['query']
