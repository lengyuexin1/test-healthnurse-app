...
export interface IOrderGetRequest {
    ...
    /** 售后详列表 */
    "/v1/bc/company/aftersale/sptDetailsByEntityId": Required<operations["sptDetailsByEntityUsingGET"]>['parameters']['query']

    /** conditionCollection */
    "/v1/bc/admin/agency/conditionCollection": Required<operations["conditionCollectionUsingGET_1"]>['parameters']['query']

    /** detail */
    "/v1/bc/admin/agency/detail": Required<operations["detailUsingGET_3"]>['parameters']['query']

    /** detail */
    "/v1/bc/app/agency/detail": Required<operations["detailUsingGET_4"]>['parameters']['query']
    ...
    /** 同步内容类目 */
    "/v1/bc/admin/category/syncContentCategory": Required<operations["syncContentCategoryUsingGET"]>['parameters']['query']
    ...
    /** 列表 */
    "/v1/bc/admin/category_show/list": Required<operations["listUsingGET_3"]>['parameters']['query']

    /** 同步内容前台类目 */
    "/v1/bc/admin/category_show/syncContentCategoryShow": Required<operations["syncContentCategoryShowUsingGET"]>['parameters']['query']

    /** 类目列表 */
    "/v1/bc/app/category_show/list": Required<operations["listUsingGET_4"]>['parameters']['query']

    /** recommendProductList */
    "/v1/bc/app/category_show/recommend/product/list": Required<operations["recommendProductListUsingGET"]>['parameters']['query']

    /** 店铺商品列表 */
    "/v1/bc/app/category_show/shop/product/list": Required<operations["shopProductListUsingGET"]>['parameters']['query']
    ...
    /** detail */
    "/v1/bc/admin/coupon/detail": Required<operations["detailUsingGET_5"]>['parameters']['query']
    ...
    /** detail */
    "/v1/bc/admin/estimate_question/detail": Required<operations["detailUsingGET_6"]>['parameters']['query']

    /** list */
    "/v1/bc/app/estimate_question/list": Required<operations["listUsingGET_5"]>['parameters']['query']

    /** detail */
    "/v1/bc/admin/estimate_record/detail": Required<operations["detailUsingGET_7"]>['parameters']['query']

    /** list */
    "/v1/bc/admin/estimate_record/list": Required<operations["listUsingGET_6"]>['parameters']['query']
    ...
    /** detail */
    "/v1/bc/admin/health/detail": Required<operations["detailUsingGET_8"]>['parameters']['query']

    /** detail */
    "/v1/bc/app/health/detail": Required<operations["detailUsingGET_9"]>['parameters']['query']

    /** 详情 */
    "/v1/bc/admin/home/mould/detail": Required<operations["detailUsingGET_10"]>['parameters']['query']

    /** 模板数据 */
    "/v1/bc/app/home/mould/data": Required<operations["getMouldUsingGET"]>['parameters']['query']
    ...
    /** 状态 */
    "/v1/bc/admin/job/status": Required<operations["listUsingGET_7"]>['parameters']['query']
    ...
    /** 详情 */
    "/v1/bc/admin/organization/order/details": Required<operations["detailsUsingGET"]>['parameters']['query']
    ...
    /** detail */
    "/v1/bc/admin/popup_config/detail": Required<operations["detailUsingGET_28"]>['parameters']['query']

    /** appList */
    "/v1/bc/app/popup_config/list": Required<operations["appListUsingGET"]>['parameters']['query']

    /** conditionCollection */
    "/v1/bc/admin/product/conditionCollection": Required<operations["conditionCollectionUsingGET_5"]>['parameters']['query']

    /** detail */
    "/v1/bc/admin/product/detail": Required<operations["detailUsingGET_29"]>['parameters']['query']

    /** detail */
    "/v1/bc/app/product/detail": Required<operations["detailUsingGET_30"]>['parameters']['query']
    ...
    /** detail */
    "/v1/bc/app/product_option/option_detail": Required<operations["detailUsingGET_31"]>['parameters']['query']

    /** detail */
    "/v1/bc/admin/product_stock/detail": Required<operations["detailUsingGET_32"]>['parameters']['query']
    ...
    /** APP店铺 Service订单总览 */
    "/v1/bc/merchant/order/stat/app_overview": Required<operations["appServiceOverviewUsingGET"]>['parameters']['query']
    ...
    /** APP店铺 商品订单总览 */
    "/v1/product/merchant/order/stat/app_overview": Required<operations["appProductOverviewUsingGET"]>['parameters']['query']
    ...
    /** 模板列表 */
    "/v1/bc/admin/template/list": Required<operations["listUsingGET_8"]>['parameters']['query']
