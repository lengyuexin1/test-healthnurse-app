...
export interface IImPostResponse {
    ...
    /** edit */
    "/v1/bc/admin/customer_service/edit": Required<operations["editUsingPOST_1"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 客服转客服 */
    "/v1/bc/admin/im/transfer_customer_service": Required<operations["transferCustomerServiceUsingPOST"]>['responses'][200]['content']['*/*']

    /** callback */
    "/v1/bc/app/im/callback": Required<operations["callbackUsingPOST"]>['responses'][200]['content']['*/*']

    /** 创作者私信用户 */
    "/v1/bc/app/im/creatorPrivateMessageUser": Required<operations["creatorPrivateMessageUserUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** 更新群成员 */
    "/v1/bc/app/im/updateTeamMemberByTid": Required<operations["updateTeamMemberByTidUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** 用户私信创作者 */
    "/v1/bc/app/im/userPrivateMessageCreator": Required<operations["userPrivateMessageCreatorUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** IM事件Log列表 */
    "/v1/bc/admin/event/event_log/list": Required<operations["getEventLogListUsingPOST"]>['responses'][200]['content']['*/*']

    /**  Message发送Log列表 */
    "/v1/bc/admin/event/msg_log/list": Required<operations["getMsgSendLogListUsingPOST"]>['responses'][200]['content']['*/*']

    /** 发送模板 */
    "/v1/bc/admin/event/send_message": Required<operations["sendMessageUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** 列表 */
    "/v1/bc/template/message/list": Required<operations["listByPageUsingPOST"]>['responses'][200]['content']['*/*']

    /** 删除 */
    "/v1/bc/template/message/remove": Required<operations["batchRemoveUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** 保存模板 */
    "/v1/bc/template/message/save": Required<operations["submitUsingPOST"]>['responses'][200]['content']['*/*']['data']
    ...
    /** recall */
    "/v1/bc/admin/notice/recall": Required<operations["recallUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** updateOrCreate */
    "/v1/bc/admin/notice/updateOrCreate": Required<operations["updateOrCreateUsingPOST"]>['responses'][200]['content']['*/*']['data']

    /** 添加可私信人员 */
    "/v1/bc/admin/private_message_config/add": Required<operations["editUsingPOST_2"]>['responses'][200]['content']['*/*']['data']

    /** 删除可私信人员 */
    "/v1/bc/admin/private_message_config/del": Required<operations["delUsingPOST_1"]>['responses'][200]['content']['*/*']['data']

    /** del */
    "/v1/bc/admin/qa_content/del": Required<operations["delUsingPOST_2"]>['responses'][200]['content']['*/*']['data']

    /** add */
    "/v1/bc/admin/qa_content/updateOrCreate": Required<operations["addUsingPOST_1"]>['responses'][200]['content']['*/*']['data']

    /** del */
    "/v1/bc/admin/short_sentence/edit": Required<operations["delUsingPOST_3"]>['responses'][200]['content']['*/*']['data']

    /** 列表 */
    "/v1/bc/template/sms/list": Required<operations["listByPageUsingPOST_1"]>['responses'][200]['content']['*/*']

    /** 删除 */
    "/v1/bc/template/sms/remove": Required<operations["batchRemoveUsingPOST_1"]>['responses'][200]['content']['*/*']['data']

    /** 保存模板 */
    "/v1/bc/template/sms/save": Required<operations["submitUsingPOST_1"]>['responses'][200]['content']['*/*']['data']
