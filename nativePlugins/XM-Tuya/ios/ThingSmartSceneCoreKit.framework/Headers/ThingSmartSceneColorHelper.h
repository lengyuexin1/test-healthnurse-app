...
/// The method generate 4-bit HHSS protocol values base on hue, saturation.
/// @param hh The Hue value, the value range 0-254.
/// @param ss The Saturation value, the value range 0-254.
///
/// @return The 4-bit HHSS protocol values.
+ (NSString *)matterHSVWithHue:(NSInteger)hh saturation:(NSInteger)ss;

/// The method generate 8-bit HHHHSSVV protocol values base on hue, saturation and brightness
/// @param hhhh The Hue value, the value range 0-360.
/// @param ss The Saturation value, the value range 0-100.
/// @param vv The Brightness value, the value range 0-100.
///
/// @return The 8-bit HHHHSSVV protocol values.
+ (NSString *)beaconHSVWithHue:(NSInteger)hhhh saturation:(NSInteger)ss brightness:(NSInteger)vv;
